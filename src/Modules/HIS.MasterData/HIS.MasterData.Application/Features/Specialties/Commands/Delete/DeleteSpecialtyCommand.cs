...
namespace HIS.MasterData.Application.Features.Specialties.Commands.Delete;
...
public class DeleteSpecialtyCommandHandler : IRequestHandler<DeleteSpecialtyCommand, Result<int>>
{
    ...
    public DeleteSpecialtyCommandHandler(IMasterDataDbContext context) { _context = context; }
