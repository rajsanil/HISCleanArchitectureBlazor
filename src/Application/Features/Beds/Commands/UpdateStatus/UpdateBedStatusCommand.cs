...
namespace CleanArchitecture.Blazor.Application.Features.Beds.Commands.UpdateStatus;
...
public class UpdateBedStatusCommandHandler : IRequestHandler<UpdateBedStatusCommand, Result<int>>
{
    ...
    public UpdateBedStatusCommandHandler(IApplicationDbContext context) { _context = context; }
